...
import styles from './EditNewsLetter.style'
...
const EditNewsLetter = ({ history }) => {
    return (
        <View style={styles.container}>


            <View style={styles.container1}>
                <Text style={styles.headerText}>Welcome to edit the newsletter. </Text>
            </View>
            ...
            <View style={styles.menucontainer}>
                ...
                <TouchableOpacity style={styles.createAccount} onPress={() => history.push('/adminNews')}>
                    <Text style={styles.textcreate1}>News</Text>
                </TouchableOpacity>
            </View>
