        ...
        <View
          ...
          style={styles.viewForSelecting}>
            <TouchableOpacity
              style={styles.button}
              onPress={
                ()=>{console.log("Menu"); Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light)}
              }
            >
            ...
            <TouchableOpacity
              style={styles.button}
              onPress={
                ()=>{console.log("Sign Up / Sign In"); Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light)}
              }
              >
